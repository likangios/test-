...
@class HsBaseAppDelegate; @class HsAppointmentSubmitView; @class HsUserSettingViewController; @class HsDoctorVisitListDataHandler; @class HsTodayDocSchListDataHandler; @class UIViewController; @class HsBaseRequest; 
...
static void _logos_method$_ungrouped$HsAppointmentSubmitView$observeValueForKeyPath$ofObject$change$context$(_LOGOS_SELF_TYPE_NORMAL HsAppointmentSubmitView* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, NSString * arg1, id arg2, id arg3, void * arg4){
    ...
    if ([arg1 isEqualToString:@"errorModel"]) {
            ...
            if([[[[arg2 valueForKeyPath:@"errorModel"] valueForKeyPath:@"userInfo"] valueForKeyPath:@"msg"] containsString:@"频率过高"]){
